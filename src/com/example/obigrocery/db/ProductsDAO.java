...
public class ProductsDAO {
	...
	private String[] allColumns = {DBTools.COLUMN_PRODUCTS_PRODUCTID, 
			DBTools.COLUMN_PRODUCTS_PRODUCTNAME, DBTools.COLUMN_PRODUCTS_CATEGORYNAME};
	...
	public Products createProducts(String productName, String categoryName) {
		 ...
		 Cursor cursor = database.query(DBTools.TABLE_PRODUCTS, allColumns,
				 DBTools.COLUMN_PRODUCTS_PRODUCTID + " = " + insertId, null, null,
				 null, null);
		 cursor.moveToFirst();
	...
	public void deleteProduct(Products product) {
		...
		//delete all listGrocery related to this product
		 ...
		 database.delete(DBTools.TABLE_PRODUCTS, DBTools.COLUMN_PRODUCTS_PRODUCTID
		 + " = " + id, null);
	}
	 ...
	 // updates a product 
	 public boolean updateProduct(long productId, String productName, String categoryName){
